...
export const config = {
    $schema: "https://www.schemastore.org/npmpackagejsonlintrc.json",
    extends: "",
    rules: {
        "bin-type": "error",
        ...
        "no-restricted-peerDependencies": [
            "error",
            ["gulping-npm-package-json-lint"],
        ],
        ...
        "no-restricted-pre-release-peerDependencies": [
            "error",
            ["gulping-npm-package-json-lint"],
        ],
        ...
        "valid-values-type": ["error", ["module", "commonjs"]],
        "version-format": "error",
        "version-type": "error",
    },
} as const satisfies NpmPackageJsonLintConfig;
